...
export default function ProductDetalis() {
  ...
  return (
    <div className="px-4 md:px-20 py-8 mt-16">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center mt-5">
        ...
        />
        <div>
          <h2 className="text-2xl font-semibold mt-4 md:mt-0">{product.productName}</h2>
      ...
      <div className="mt-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-2">
          <h3 className="text-lg font-semibold border-b-2 border-transparent hover:border-blue-500 cursor-pointer">Description</h3>
          <button
            onClick={() => setShowReviews(!showReviews)}
            className="sm:ml-4 text-black-600 p-3"
          >
            Reviews (2)
          </button>
        </div>
      ...
      <div className="mt-12">
        <h2 className="text-xl font-bold mb-5 text-center">You might also like</h2>
